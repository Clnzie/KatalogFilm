...
// To parse this JSON data, do
//
//     final movieTrailerList = movieTrailerListFromJson(jsonString);

// import 'dart:convert';

MovieTrailerList movieTrailerListFromJson(String str) =>
    MovieTrailerList.fromJson(json.decode(str));

String movieTrailerListToJson(MovieTrailerList data) =>
...
class MovieTrailerList {
  ...
  factory MovieTrailerList.fromJson(Map<String, dynamic> json) =>
      MovieTrailerList(
        iso6391: json["iso_639_1"],
        iso31661: json["iso_3166_1"],
        name: json["name"],
